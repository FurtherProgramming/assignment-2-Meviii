...
public class AdminManageEmployeeController implements Initializable {
    ...
    public void AdminManageEmpToDeleteEmp(ActionEvent event) throws IOException {
    ...
    public void AdminManageEmpToDeactivateEmp(ActionEvent event) throws IOException {
    ...
    public void AdminManageEmpToAddEmp(ActionEvent event) throws IOException {
    ...
    public void AdminManageEmpToUpdateEmp(ActionEvent event) throws IOException {
